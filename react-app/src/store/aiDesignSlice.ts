...
// יצירת ה-undoable slice עם ההגדרות הנכונות
const undoableAiDesignSlice = undoable(aiDesignSlice.reducer, {
    filter: includeAction([
        "aiDesign/setImageData", // שם נכון של הפעולה
        "aiDesign/updateFilters", // שם נכון של הפעולה
        "aiDesign/updateFilter", // שם נכון של הפעולה
        "aiDesign/resetFilters", // שם נכון של הפעולה
        "aiDesign/generateDesign/fulfilled", // גם הפעולה של ה-API
    ]),
    limit: 20,
    // debug: process.env.NODE_ENV === "development",
})

// ייצוא הפעולות מה-slice המקורי
